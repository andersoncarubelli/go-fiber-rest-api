...
func (q *BookQueries) CreateBook(b *models.Book) error {
	...
	_, err := q.Exec(query, b.ID, b.CreatedAt, b.UpdatedAt, b.UserID, b.Title, b.BookAttrs)
...
func (q *BookQueries) UpdateBook(id uuid.UUID, b *models.Book) error {
	query := `UPDATE books SET updated+at = $2, title = $3, author = $4, book_status = $5, book_attrs = $6 WHERE id = $1`
